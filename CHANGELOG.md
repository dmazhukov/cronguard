...
- **`cronguard_next_expected_timestamp_seconds` is absent instead of 0 when there is no upcoming slot.** 0 reads as a run expected on 1970-01-01, the same class of error v0.3.2 removed from the last-success panel.

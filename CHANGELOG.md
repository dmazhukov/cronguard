...
- **`golang.org/x/text` bumped to v0.40.0 (GO-2026-5970).** The vulnerability was reachable and sat undetected for ten weeks because `govulncheck` only ran on push and pull request, and there had been no push.
